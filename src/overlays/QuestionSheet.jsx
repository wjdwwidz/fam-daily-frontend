    ...
    <Pressable onPress={vm.closeQuestion} style={s('position:absolute;inset:0;background:rgba(23,48,59,0.5);z-index:45;align-items:flex-end;animation:sfade .18s ease')}>
      <Pressable onPress={vm.stopEvt} style={s('width:100%;background:#fff;border-radius:26px 26px 0 0;padding:5xl 5xl 7xl;animation:sheetup .26s cubic-bezier(.4,0,.2,1)')}>
        ...
        <TextInput
          ...
          style={s('width:100%;min-height:88px;margin-top:3xl;border:1px solid #FFE1EC;outline:none;background:#FFF6FB;border-radius:14px;padding:2xl 3xl;font-size:13.5px;font-family:inherit;color:#17303B;resize:none')}
        />
        ...
        <Pressable onPress={vm.submitQuestion} style={s('margin-top:4xl;height:54px;border-radius:17px;background:#FF5E8A;align-items:center;justify-content:center;cursor:pointer')}>
