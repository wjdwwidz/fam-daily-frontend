  ...
  return (
    <Pressable onPress={vm.closeAddEvent} style={s('position:absolute;inset:0;background:rgba(23,48,59,0.5);z-index:45;flex-direction:row;align-items:flex-end')}>
      <Pressable onPress={vm.stopEvt} style={s('width:100%;background:#fff;border-radius:26px 26px 0 0;padding:20px 20px 28px')}>
        ...
        <Text style={s('font-size:15.7px;font-weight:800;color:#17303B;margin-bottom:16px')}>일정 추가</Text>
        <TextInput placeholder="일정 이름" placeholderTextColor="#9DB2BD" style={s('width:100%;border:1px solid #FFE1EC;background:#FFF6FB;border-radius:14px;padding:14px 15px;font-size:13.1px;font-family:inherit;color:#17303B')} />
        <View style={s('flex-direction:row;gap:6px;background:#FFF0F5;border-radius:13px;padding:4px;margin-top:12px')}>
        ...
        {vm.isRange && (
          <>
            <View style={s('flex-direction:row;align-items:center;gap:8px;margin-top:12px')}>
              <View style={s('flex:1;flex-direction:row;align-items:center;gap:8px;border:1px solid #FFE1EC;background:#FFF6FB;border-radius:14px;padding:14px 13px')}>
            ...
            <Text style={s('font-size:10.5px;color:#9DB2BD;margin:8px 2px 0')}>캘린더에 3박 4일 동안 색으로 이어져 표시돼요</Text>
          </>
        )}
        {vm.isOneDay && (
          <View style={s('flex-direction:row;align-items:center;gap:10px;margin-top:12px;border:1px solid #FFE1EC;background:#FFF6FB;border-radius:14px;padding:14px 15px')}>
        ...
        <Text style={s('font-size:11.3px;font-weight:700;color:#17303B;margin:20px 2px 12px')}>색상 <Text style={s('font-weight:500;color:#9DB2BD')}>· 일정 종류를 색으로 구분해요</Text></Text>
        <View style={s('flex-direction:row;justify-content:space-between;padding:0 2px')}>
        ...
        <Pressable onPress={vm.closeAddEvent} style={s('margin-top:24px;height:54px;border-radius:17px;background:#FF5E8A;align-items:center;justify-content:center')}>
