  ...
  return (
    <Pressable onPress={vm.closeLinkSheet} style={s('position:absolute;inset:0;background:rgba(23,48,59,0.5);z-index:46;display:flex;align-items:flex-end;animation:sfade .18s ease')}>
      <Pressable onPress={vm.stopEvt} style={s('width:100%;background:#fff;border-radius:26px 26px 0 0;padding:5xl 5xl 7xl;animation:sheetup .26s cubic-bezier(.4,0,.2,1)')}>
        ...
        <Text style={s('font-size:11.5px;color:#9DB2BD;margin-top:sm;margin-bottom:3xl')}>가족에게 받은 초대 링크를 붙여넣어 주세요</Text>
        <View style={s('display:flex;align-items:center;gap:md;border:1px solid #FFE1EC;background:#FFF6FB;border-radius:14px;padding:sm sm sm 3xl')}>
