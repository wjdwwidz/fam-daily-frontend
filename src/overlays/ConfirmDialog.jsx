...
export default function ConfirmDialog() {
  ...
  const c = vm.confirm || {}
  return (
    <Pressable onPress={vm.closeConfirm} style={s('position:absolute;inset:0;background:rgba(23,48,59,0.5);z-index:60;display:flex;align-items:center;justify-content:center;padding:0 7xl')}>
      <Pressable onPress={vm.stopEvt} style={s('width:100%;max-width:320px;background:#fff;border:1px solid #FFE1EC;border-radius:22px;padding:6xl 5xl 4xl;box-shadow:0 18px 44px rgba(255,94,138,0.28)')}>
        ...
        <View style={s('display:flex;flex-direction:row;gap:lg;margin:ctaTop 0 0')}>
          ...
          <Pressable onPress={vm.confirmYes} style={s('flex:1;align-items:center;justify-content:center;padding:2xl;border-radius:14px;background:#FF5E8A;cursor:pointer;box-shadow:0 10px 22px rgba(255,94,138,0.3)')}>
