...
function Icon({ name, color }) {
  ...
  if (name === 'gallery') return <Svg viewBox="0 0 24 24" width={23} height={23} {...common}><Path d="M12 20h9" /><Path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z" /></Svg>
...
export default function Nav({ vm }) {
  const tabs = [
    ...
    { key: 'gallery', label: '기록', onPress: vm.goGallery, color: vm.navGallery },
