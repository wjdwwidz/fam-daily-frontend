...
function Icon({ name, color }) {
  ...
  if (name === 'record') return <Svg viewBox="0 0 24 24" width={23} height={23} {...common}><Path d="M7 3.5 h6.5 L18 8 v12.5 H7 Z" /><Path d="M13.2 3.7 V8 H17.8" /><Path d="M9.5 12.5 h5" /><Path d="M9.5 15.5 h5" /></Svg>
