...
export default function QnaHistory({ vm }) {
  return (
    <View style={s('padding:8px 20px 110px')}>
      <View style={s('display:flex;align-items:center;gap:12px;margin:6px 0 6px')}>
      ...
      <Text style={s('font-size:11.3px;color:#9DB2BD;margin:0 2px 14px')}>지금까지 함께한 {vm.qnaHistoryTotal}개의 질문</Text>
      <View style={s('background:#FCEEF4;border-radius:20px;padding:4px 16px 8px')}>
