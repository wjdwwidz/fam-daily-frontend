...
export default function JoinSpace() {
  const vm = useVm()
  return (
    <View style={s('flex:1;min-height:768px;padding:0 0 8xl;background:#FFF6FB')}>
      <View style={s('flex-direction:row;align-items:center;justify-content:space-between;padding:sm 4xl sm')}>
      ...
      <View style={s('flex:1;padding:2xl 6xl 0')}>
        ...
        <Pressable onPress={vm.doJoinGroup} disabled={vm.actionLoading} style={s(`height:54px;border-radius:17px;background:${vm.actionLoading ? '#F3C6D5' : '#FF5E8A'};align-items:center;justify-content:center;flex-direction:row;gap:md`)}>
