...
export default function CreateSpace({ vm }) {
  return (
    <View style={s('min-height:768px;padding:0 0 40px;background:#FFF6FB')}>
      ...
      <View style={s('padding:22px 24px 0')}>
        ...
        <TextInput value="서연이네 가족" placeholderTextColor="#9DB2BD" style={s('width:100%;border:1px solid #FFE1EC;outline:none;background:#fff;border-radius:14px;padding:14px 15px;font-size:13.5px;font-weight:600;font-family:inherit;color:#17303B')} />
        <Text style={s('font-size:11.3px;font-weight:700;color:#17303B;margin:18px 0 8px')}>내 호칭</Text>
        <TextInput value="엄마" placeholderTextColor="#9DB2BD" style={s('width:100%;border:1px solid #FFE1EC;outline:none;background:#fff;border-radius:14px;padding:14px 15px;font-size:13.5px;font-weight:600;font-family:inherit;color:#17303B')} />
        <Text style={s('font-size:11px;color:#9DB2BD;margin-top:8px;line-height:1.5')}>공간을 만들면 내가 관리자가 되고,{'\n'}가족을 초대할 수 있어요</Text>
        <Pressable onPress={vm.finishOnboard} style={s('margin-top:28px;height:54px;border-radius:17px;background:#FF5E8A;display:flex;align-items:center;justify-content:center;cursor:pointer')}>
