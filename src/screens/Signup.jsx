...
export default function Signup({ vm }) {
  return (
    <View style={s('min-height:768px;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:40px 32px;text-align:center;background:#FFF6FB;position:relative')}>
      ...
      <Text style={s('font-size:14px;color:#6A7E88;margin-top:12px;line-height:1.6;max-width:250px')}>카카오 프로필로 시작해요.{'\n'}이제 우리 가족 공간을 만들어볼까요?</Text>
      <Pressable onPress={vm.goSpace} style={s('width:100%;margin-top:42px;height:56px;border-radius:20px;background:#FF5E8A;display:flex;align-items:center;justify-content:center;font-size:16px;font-weight:700;color:#fff;cursor:pointer')}>
