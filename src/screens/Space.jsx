...
export default function Space({ vm }) {
  return (
    <View style={s('min-height:768px;display:flex;flex-direction:column;padding:72px 28px 40px;background:#FFF6FB;position:relative')}>
      <Pressable onPress={vm.goSignupBack} style={s('position:absolute;top:18px;left:18px;width:40px;height:40px;border-radius:13px;background:#fff;border:1px solid #FFE1EC;box-shadow:0 10px 24px rgba(255,94,138,0.13);display:flex;align-items:center;justify-content:center;cursor:pointer;color:#17303B')}>
      ...
      <Text style={s('font-size:13px;color:#6A7E88;margin-top:10px')}>새로 만들거나, 초대받은 가족방에 참여하세요</Text>
      <View style={s('display:flex;flex-direction:column;gap:14px;margin-top:34px')}>
        <Pressable onPress={vm.goCreate} style={s('display:flex;align-items:center;gap:14px;background:#fff;border:1px solid #FFE1EC;box-shadow:0 10px 24px rgba(255,94,138,0.13);border-radius:22px;padding:18px 18px;cursor:pointer')}>
          ...
          <View style={s('flex:1')}>
            ...
            <Text style={s('font-size:11.5px;color:#9DB2BD;margin-top:2px')}>우리 가족의 첫 공간을 열어요</Text>
          </View>
        ...
        <Pressable onPress={vm.goJoin} style={s('display:flex;align-items:center;gap:14px;background:#fff;border:1px solid #FFE1EC;box-shadow:0 10px 24px rgba(255,94,138,0.13);border-radius:22px;padding:18px 18px;cursor:pointer')}>
          ...
          <View style={s('flex:1')}>
            ...
            <Text style={s('font-size:11.5px;color:#9DB2BD;margin-top:2px')}>가족이 보낸 링크로 들어가요</Text>
          </View>
          <Svg viewBox="0 0 24 24" width={18} height={18} fill="none" stroke="#D9C3CC" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
            <Path d="M9 6 L15 12 L9 18" />
          </Svg>
