...
export function AppProvider({ initialScreen = 'login', variant = 'grid', children }) {
  ...
  const back = () =>
    setState((p) => {
      ...
      const map = { word: 'record', media: 'gallery', upload: 'home', members: 'home', moodhistory: 'home', qnahistory: 'record', spaceSelect: 'login', space: 'spaceSelect', createSpace: 'space', joinSpace: 'space', signup: 'login' }
